...
import { i18n, Locale, parseLocale } from 'sanity/lib/i18n'
...
export const getPathnameParts = (params: Params, options?: { isBlog?: boolean }) => {
	const lang = (parseLocale(params.lang) ?? (i18n.stripBase ? i18n.base : undefined)) as typeof i18n.stripBase extends true ? Locale : Locale | undefined
