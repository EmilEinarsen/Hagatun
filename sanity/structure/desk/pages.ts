          ...
          S.listItem()
            ...
            .child(
              S.documentTypeList('page')
                ...
                .canHandleIntent(
                  (intent, {type}) => ['create', 'edit'].includes(intent) && type === 'page'
                )
            ),
          S.listItem()
            .title('Other Pages')
          ...
          S.listItem()
            ...
            .child(
              S.documentTypeList('section')
                .title('Reusable Sections')
                .child((documentId) => S.document().documentId(documentId).schemaType('section'))
                .canHandleIntent(
                  (intent, {type}) => ['create', 'edit'].includes(intent) && type === 'section'
                )
            ),
        ])
    )
